...
class RAGServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Ingest = channel.unary_unary(
                ...
                request_serializer=rag__pb2.IngestRequest.SerializeToString,
                response_deserializer=rag__pb2.IngestResponse.FromString,
...
def add_RAGServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Ingest': grpc.unary_unary_rpc_method_handler(
                    servicer.Ingest,
                    request_deserializer=rag__pb2.IngestRequest.FromString,
                    response_serializer=rag__pb2.IngestResponse.SerializeToString,
            ),
...
class RAGService(object):
    ...
    def Ingest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rag.RAGService/Ingest',
            rag__pb2.IngestRequest.SerializeToString,
            rag__pb2.IngestResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
